...
- **Vokabulare nachschlagen** — Alle 13 offiziellen BSI-Namespace-CSVs direkt aus dem freigegebenen Verzeichnis als eigenständige, provenance- und integritätsgesicherte Übersichten. Schutzziel-Typen und ihre Relevanzstufen `0`–`2` werden in Kontrolldetails getrennt erklärt; nicht auflösbare Relevanzwerte bleiben sichtbar diagnostizierbar. Route `/vokabular`.
