...
describe('Footer', () => {
  ...
  it('uses the responsive two-line layout contract for footer metadata and secondary links', () => {
    render(
      <MemoryRouter>
        <Footer />
      </MemoryRouter>,
    ...
    expect(sourceLink).toHaveClass('flex-1', 'min-w-0', 'lg:flex-none', 'lg:mr-auto');
