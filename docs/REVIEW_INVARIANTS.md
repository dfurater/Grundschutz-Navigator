...
**Scope:** `scripts/verify-upstream-oscal.mjs`, `scripts/verify-upstream-oscal.test.ts`, `src/domain/sourceRegistry.mjs`, `upstream-manifest.json`, `.github/workflows/ci.yml`, `docs/OSCAL_VALIDATION.md`
...
**Scope:** `src/domain/oscalSchemaBundle.ts`, `src/domain/oscalSchemaValidation.ts`, `src/domain/oscalClass2Import.ts`, `src/workers/**`, `scripts/verify-oscal-schemas.mjs`, `scripts/sync-oscal-schemas.mjs`, `schemas/**`, `.gitattributes`, `vite.config.ts`, `.github/workflows/ci.yml`
...
**Scope:** `docs/ARCHITECTURE.md`, `scripts/verify-documented-versions.mjs`, `.github/workflows/ci.yml`, `package.json`
