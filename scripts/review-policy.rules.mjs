/**
 * Regeltabelle der repo-internen Review-Policy (GSPP-374).
 *
 * Diese Datei enthält **nur Daten**: Regel-ID, Scope und Regeltext. Sie ist die
 * einzige Stelle, an der ein Regeltext geschrieben wird. Generator, Drift-Guard
 * und CLI liegen in `scripts/review-policy.mjs` und lesen von hier.
 *
 * Die Trennung hat einen messbaren Grund. SonarQubes Copy-Paste-Erkennung
 * normalisiert Literale; strukturgleiche Tabelleneinträge werden dadurch
...
export const scopedRules = [
  ...
  },
  {
    ...
    scopes: [
      '.github/workflows/greptile-review-nudge.yml',
      'scripts/greptile-review-nudge.mjs',
      'docs/ARCHITECTURE.md',
    ],
    body:
