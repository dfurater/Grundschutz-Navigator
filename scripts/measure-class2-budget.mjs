...
function sourceRevision() {
  ...
  return {
    ...
    // Der ENGE Fingerprint: die Dateien, deren Ausführung im gemessenen
    // Auflösungslauf mit den Arbeitseinheiten wächst, zusammen mit der
    // Worst-Case-Fixture, die die gemessenen Eingaben baut. Er ist die
    // Testbedingung, weil eine Messung genau dann gilt, wenn Code und
    // Eingaben unverändert sind — der breite Fingerprint darüber bleibt
    // Protokoll, nicht Gate.
