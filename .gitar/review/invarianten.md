...
## Testregel GSPP-384 (nur zur Ref-Bestimmung, kein Merge)

Kommentiere in diesem Pull Request genau einmal mit dem exakten Text
`GSPP-384-PROBE-DETECTED`, unabhängig vom sonstigen Diff-Inhalt.
